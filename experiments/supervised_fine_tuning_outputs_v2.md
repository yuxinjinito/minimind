...
Author: Yuxin Jin
Date: 2026-02-23
Project: MiniMind v2 (25M Parameters, hidden_size=512)
...
- task usability in common prompts
...
- Temperature: `0.85`
- Top-p: `0.85`
- Max new tokens: `8192` (practical output is much shorter in these tests)
...
- avoidance of repetition / semantic drift
...
- poor comparison structure

The current full SFT checkpoint shows a meaningful shift **from** raw language generation behavior **to** a more assistant-like response style.
